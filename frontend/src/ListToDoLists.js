...
function ListToDoLists({
    ...
    if (listSummaries === null) {
        ...
        return (<div className="ListToDoLists">
            <div className="box">
                <label htmlFor="new-to-do-list">New To-Do List:
                    <input id={labelRef} type="text" />
                </label>
                <button onClick={() =>
                    handleNewToDoList(document.getElementById(labelRef).value)}>New</button>
